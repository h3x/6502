...
reset:
 ...
 lda #1
 sta PORTA ; Serial idle

 lda #"*"
 sta $0200

 lda #$01
 trb PORTA ; Set pin 1 without distubing the rest of port a. Send start bit

 ldx #8
write_bit:
 jsr bit_delay
 ror $0200  ; Rotate the next bit right into carry flag
 bcs send_1
 trb PORTA ; send a 0
 jmp tx_done
send_1:
